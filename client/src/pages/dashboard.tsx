                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              <div>
                                <p className="font-medium text-gray-700">💰 Importo</p>
                                <p className="text-gray-600">€{purchase.packagePrice}</p>
                              </div>
                              <div>
                                <p className="font-medium text-gray-700">🎯 Crediti</p>
                                <p className="text-gray-600">{purchase.creditsAmount} crediti</p>
                              </div>
                              <div>
                                <p className="font-medium text-gray-700">📅 Data Ordine</p>
                                <p className="text-gray-600">{new Date(purchase.createdAt).toLocaleDateString('it-IT', {
                                  day: '2-digit',
                                  month: '2-digit',
                                  year: 'numeric',
                                  hour: '2-digit',
                              ...
                              {purchase.processedAt && (
                                <div>
                                  <p className="font-medium text-gray-700">⏰ Data Elaborazione</p>
                                  <p className="text-gray-600">{new Date(purchase.processedAt).toLocaleDateString('it-IT', {
                                    day: '2-digit',
                                    month: '2-digit',
                                    year: 'numeric',
                                    hour: '2-digit',
                              ...
                              {purchase.processedBy && (
                                <div>
                                  <p className="font-medium text-gray-700">👤 Elaborato da</p>
                                  <p className="text-gray-600">{purchase.processedBy}</p>
                                </div>
                              )}
                              {purchase.notes && (
                                <div className="md:col-span-3">
                                  <p className="font-medium text-gray-700">📝 Note Amministratore</p>
                                  <p className="text-gray-600 bg-gray-50 p-2 rounded mt-1">{purchase.notes}</p>
                                </div>
                              )}
                            </div>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                      <div className="text-center">
                        ...
                        <p className="text-lg font-bold">{creditPurchases.filter((p: any) => p.status === 'approved').length}</p>
                      </div>
                      <div className="text-center">
                        <p className="font-medium text-orange-700">⏳ In Attesa</p>
                        <p className="text-lg font-bold">{creditPurchases.filter((p: any) => p.status === 'pending').length}</p>
                      </div>
                      <div className="text-center">
                        <p className="font-medium text-red-700">❌ Rifiutati</p>
                        <p className="text-lg font-bold">{creditPurchases.filter((p: any) => p.status === 'rejected').length}</p>
                      </div>
                      <div className="text-center">
                        <p className="font-medium text-blue-700">💰 Totale Speso</p>
                        <p className="text-lg font-bold">€{creditPurchases.filter((p: any) => p.status === 'approved').reduce((sum: number, p: any) => sum + p.packagePrice, 0)}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
